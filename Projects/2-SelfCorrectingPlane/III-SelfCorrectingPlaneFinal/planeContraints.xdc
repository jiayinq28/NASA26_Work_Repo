...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y9 [get_ports {clk}];  # Connected to "clk" on the top module

# ----------------------------------------------------------------------------
# JA Pmod - Bank 13 - Used to receive the data from the two sensors 
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN Y11  [get_ports {JA1}];  # "JA1"
#set_property PACKAGE_PIN AA11 [get_ports {JA2}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {right_echo}];  # "JA3" (Right US-100 Echo)
set_property PACKAGE_PIN AA9  [get_ports {right_trig}];  # "JA4" (Right US-100 Trigger)
set_property PACKAGE_PIN AB11 [get_ports {left_echo}];  # "JA7" (Left US-100 Echo)
set_property PACKAGE_PIN AB10 [get_ports {left_trig}];  # "JA8" (Left US-100 Trigger)
#set_property PACKAGE_PIN AB9  [get_ports {JA9}];  # "JA9"
#set_property PACKAGE_PIN AA8  [get_ports {JA10}];  # "JA10"

# ----------------------------------------------------------------------------
# JB Pmod - Bank 13 - Used to send and receive data from the Batan S1213 Servo
# ---------------------------------------------------------------------------- 
...
set_property PACKAGE_PIN W8 [get_ports {servo_pwm}];  # "JB4"    (Servo PWM output)
...
# ----------------------------------------------------------------------------
# User LEDs - Bank 33 =- Used to plane's motion, also used to make sure sensors work
# ---------------------------------------------------------------------------- 
...
## ----------------------------------------------------------------------------
## User DIP Switches - Bank 35 - Used to interface when the system is on or off
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {SW0}];  # "SW0" (System Enable Switch)
