...
//    output oled_cs,// used in Pmod OLED implementation
    ...
    // str3 and str4 are now driven dynamically by mkOledTop below
...
//    assign oled_cs = 1'b0;
    ...
    // left-pad each 8-char (64-bit) row out to 16 chars (128 bits) to fill the OLED row width
    assign str3 = {64'h2020202020202020, oledTop_binary_row};
    ...
    assign led = oledTop_leds;//lights up the leds associated with the switches, via mkOledTop
